...
Task planning and execution in **this API repo** (`mentorhub_admin_spa`) must not read or depend on other sibling repositories for input context, except:
...
- ../mentorhub/Workshops/admin_journey_issues.md
