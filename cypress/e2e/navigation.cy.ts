describe('Navigation Drawer', () => {
  ...
  it('should open navigation drawer with hamburger menu', () => {
    ...
    cy.contains('CARD DOMAIN').should('be.exist')
  ...
  it('should have all card domain links in drawer', () => {
    cy.visit('/cards')
    cy.get('[data-automation-id="nav-drawer-toggle"]').click()
    
    cy.get('[data-automation-id="nav-cards-list-link"]').scrollIntoView().should('be.visible')
    cy.get('[data-automation-id="nav-cards-new-link"]').scrollIntoView().should('be.visible')
  })
